...
function addH(){
	$('#screenshot-carousel').append('<ol class="carousel-indicators">');
  	$('#screenshot-carousel').append('<li data-target="#screenshot-carousel" data-slide-to="0" class="active"></li>');
	$('#screenshot-carousel').append('<li data-target="#screenshot-carousel" data-slide-to="1"></li>');
	$('#screenshot-carousel').append('<li data-target="#screenshot-carousel" data-slide-to="2"></li></ol>');
  	$('#screenshot-carousel').append('<div class="carousel-inner">');
	$('#screenshot-carousel').append('<div class="item active">');
	$('#screenshot-carousel').append('<img src="Logo.jpg" alt="Text of the image" height = "1020" width = "1200">');			
  	$('#screenshot-carousel').append('</div>');				
  	$('#screenshot-carousel').append('<div class="item">');					
  	$('#screenshot-carousel').append('<img src="Clubs.jpg" alt="Text of the image" height = "1020" width = "1200"></div>');				
  	$('#screenshot-carousel').append('<div class="item"><img src="Ball.jpg" alt="Text of the image" height = "1020" width = "1200"></div>');				
  	$('#screenshot-carousel').append('</div>');	
  	$('#screenshot-carousel').append('<a href="#screenshot-carousel" class="left carousel-control" data-slide="prev">');
  	$('#screenshot-carousel').append('<span class="glyphicon glyphicon-chevron-left"></span>');			
  	$('#screenshot-carousel').append('</a>');				
  	$('#screenshot-carousel').append('<a href="#screenshot-carousel" class="right carousel-control" data-slide="next">');			
  	$('#screenshot-carousel').append('<span class="glyphicon glyphicon-chevron-right"></span></a>');
}
function myFunction() {
    var x = document.getElementById('screenshot-carousel');
